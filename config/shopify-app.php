...
return [
    ...
    */
    ...
    |
    */
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'write_payment_customizations,read_payment_customizations,read_translations,read_locales'),
    ...
    */
    ...
    'api_redirect' => env('SHOPIFY_API_REDIRECT', env('APP_URL').'/authenticate'),
